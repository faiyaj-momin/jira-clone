...
import { useGetWorkspaceAnalytics } from '@/features/workspaces/api/use-get-woekspace-analytics';
...
export const WorkspaceIdClient = () => {
  ...
  const { data: analytics, isFetching: isLoadingAnalytics } =
  ...
  return (
    <div className="h-full flex flex-col space-y-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <MemberList data={members.members} total={members.total} />
      </div>
    </div>
  );
};
